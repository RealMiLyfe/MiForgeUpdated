  ...
  const testIssues = [
    {
      ...
      body: "I'm trying to authenticate MiForge with my GitHub account but it keeps failing. I'm on macOS Sonoma. Error: 'Authentication failed - invalid credentials'",
    },
    {
      number: 5002,
    ...
    },
    {
      ...
      body: "I'm unable to connect to remote servers via SSH when using MiForge on WSL2. The connection times out after 30 seconds. My SSH keys are configured correctly and work fine in regular WSL2 terminal.",
    },
  ];
